...
--
local images = {
    ['gradient'] = "https://raw.githubusercontent.com/portallol/luna/main/Gradient.png";
}
for i,v in next, images do
    if not isfile(library.settings.folder_name..'/assets/'..i..'.ln') then
        writefile(library.settings.folder_name..'/assets/'..i..'.ln', syn.crypt.custom.encrypt('aes-ctr',game:HttpGet(v),'4XGudgFuutoHUM2Ctwsq4YrQ','zP5JJWPSIbf5Xuuy'))
    end
    images[i] = syn.crypt.custom.decrypt('aes-ctr',readfile(library.settings.folder_name..'/assets/'..i..'.ln'),'4XGudgFuutoHUM2Ctwsq4YrQ','zP5JJWPSIbf5Xuuy')
end
-- // Functions
